...
<rss version="2.0">
<channel>
<title>Animekisa {types[type-1]} - RSS Feed</title>
<link>https://github.com/ArjixGamer/anime-rss</link>
<description>A simple RSS feed for Animekisa!</description>
"""
...
""".format(f"{item[2]} - Episode {item[1]}", "https://animekisa.tv/" + item[0], f"Episode {item[1]} of {item[2]} is out!")
...
for type_ in types:
    filename = f'/home/lzsjinxin/Documents/GitHub/lzsjinxin/anime-rss/animekisa/animekisa-rss-{type_}.xml'
